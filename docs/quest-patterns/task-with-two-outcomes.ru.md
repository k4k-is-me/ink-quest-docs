...
- `to: 0` — условие сработает, когда счёт **опустится** до 0. Поскольку `from > to`, условие читается как нисходящее (см. [УСЛОВИЯ ВЫПОЛНЕНИЯ ЗАДАЧИ](/datapack-reference/task-completion-conditions.md)).
