...
> Свитки на разные квесты не объединяются в стак (NBT различается). Максимум стака — 16.

Что происходит при использовании свитка — выдача квеста, расход, кулдаун, причины отказа — в [Предметы](/player-view/items.md#свиток-квеста).
